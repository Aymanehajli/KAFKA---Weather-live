...
# Script pour exécuter l'enrichisseur de profils saisonniers

echo "=========================================="
echo "Démarrage de l'enrichisseur de profils saisonniers"
echo "=========================================="
echo ""
...
docker cp seasonal_profile_enricher.py pyspark_notebook:/home/jovyan/work/seasonal_profile_enricher.py

# Exécuter l'enrichisseur
echo "🚀 Démarrage de l'enrichisseur..."
echo ""
